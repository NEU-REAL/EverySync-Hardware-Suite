...
public:
  ...
  void ext_clkCallback(const versavis::TimeNumbered &ext_clk_time_msg);//added 2022.5.6 by kang
  ...
  void imuTimeCallback(const versavis::TimeNumbered &imu_time_msg);//added 2022.5.6 by kang
...
private:
  ...
  std::vector<versavis::TimeNumbered> imu_time_stamp_candidates_;//added 2022.5.6 by kang
