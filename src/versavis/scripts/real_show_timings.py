...
def main():
    ...
    arduino_time_nsec = [msg.time.nsecs for (topic, msg, t) in input_bag.read_messages(topics=[args.topic])]
    arduino_time_sec = [msg.time.secs for (topic, msg, t) in input_bag.read_messages(topics=[args.topic])]
