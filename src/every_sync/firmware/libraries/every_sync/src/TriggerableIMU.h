...
#ifndef TriggerableIMU_h
#define TriggerableIMU_h
...
class TriggerableIMU : public Sensor {
public:
  TriggerableIMU(ros::NodeHandle *nh, const String &topic, const int rate_hz,
...
//   versavis::TimeNumbered image_time_msg_;
    every_sync::TimeNumbered imu_time_msg_;
...
//   uint32_t image_number_;
  ...
  ros::Subscriber<std_msgs::Bool, TriggerableIMU> init_subscriber_;
  bool initialized_;
};
