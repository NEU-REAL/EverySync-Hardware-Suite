...
// added by kangkang 2023.4.27
#ifdef PPS_MODULE
static void ppsCb(const std_msgs::UInt8 &msg) {
  analogWrite(PPS_PWM_PIN, msg.data);
}
#endif
#ifdef PPS_MODULE
ros::Subscriber<std_msgs::UInt8> pps_sub("/versavis/pps_pwm", &ppsCb);
#endif
...
// added by kangkang 2023.4.27
#ifdef PPS_MODULE
  pinMode(PPS_PWM_PIN, OUTPUT);
  pinMode(PPS_PIN, OUTPUT);
  analogWrite(PPS_PWM_PIN, 0);
