...
def main():
    ...
    ard_img0_arrival_time_nsec = [t.nsecs for (topic, msg, t) in input_bag.read_messages(topics=['/versavis/cam1/image_time'])]
    ard_img0_arrival_time_sec = [t.secs for (topic, msg, t) in input_bag.read_messages(topics=['/versavis/cam1/image_time'])]
    ard_img0_timestamp_nsec = [msg.time.nsecs for (topic, msg, t) in input_bag.read_messages(topics=['/versavis/cam1/image_time'])]
    ard_img0_timestamp_sec = [msg.time.secs for (topic, msg, t) in input_bag.read_messages(topics=['/versavis/cam1/image_time'])]
    ard_img1_arrival_time_nsec = [t.nsecs for (topic, msg, t) in input_bag.read_messages(topics=['/versavis/cam2/image_time'])]
    ard_img1_arrival_time_sec = [t.secs for (topic, msg, t) in input_bag.read_messages(topics=['/versavis/cam2/image_time'])]
    ard_img1_timestamp_nsec = [msg.time.nsecs for (topic, msg, t) in input_bag.read_messages(topics=['/versavis/cam2/image_time'])]
    ard_img1_timestamp_sec = [msg.time.secs for (topic, msg, t) in input_bag.read_messages(topics=['/versavis/cam2/image_time'])]
    
    imu_arrival_time_nsec = [t.nsecs for (topic, msg, t) in input_bag.read_messages(topics=['/versavis/xsens_imu/data'])]
    imu_arrival_time_sec = [t.secs for (topic, msg, t) in input_bag.read_messages(topics=['/versavis/xsens_imu/data'])]
    imu_timestamp_nsec = [msg.time.nsecs for (topic, msg, t) in input_bag.read_messages(topics=['/versavis/xsens_imu/image_time'])]
    imu_timestamp_sec = [msg.time.secs for (topic, msg, t) in input_bag.read_messages(topics=['/versavis/xsens_imu/image_time'])]
