...
public:
  Lidar(ros::NodeHandle *nh, const String &topic, const int rate_hz,
  ...
  void pps_send_utc_time();  
  void pps_send_utc_time_from_100hz();                                       
...
//   versavis::TimeNumbered image_time_msg_;
    versavis::TimeNumbered pps_time_msg_;
...
//   uint32_t image_number_;
  ...
  ros::Subscriber<std_msgs::Bool, Lidar> init_subscriber_;
  bool initialized_;
};
